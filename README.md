...
> **全体像は [`docs/00-index.html`](docs/00-index.html) にまとめてある。**
> 仕組み・実機での検証結果・資料へのリンク・現在地・正直な限界を1枚で。
> **GitHub 上では生の HTML に見えるので、clone して手元のブラウザで開くこと**
> （`open docs/00-index.html` / `xdg-open docs/00-index.html`）。
